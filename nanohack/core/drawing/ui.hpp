...
namespace plusminus::ui
{
	...
	inline void OnSetupDevice()
	{
		...
		wrapper::create_window(xorstr_("Vos.club"), Vector2(200, 200), Vector2(580, 360), VK_INSERT); //Vector2 (<->, высота) 
		wrapper::tabs({ xorstr_("Combat"), xorstr_("Visual"), xorstr_("Misc"), xorstr_("Colors"), xorstr_("Game")});

		// == Visuals == \\

		wrapper::checkbox(xorstr_("players"), Vector2(0, 0), Tabs::Visual);
		wrapper::checkbox(xorstr_("name"), Vector2(0, 0), Tabs::Visual);
		wrapper::checkbox(xorstr_("dist"), Vector2(0, 0), Tabs::Visual);
		...
		wrapper::checkbox(xorstr_("collectable"), Vector2(160.0f, 0), Tabs::Visual);
		...
		wrapper::checkbox(xorstr_("helicopter"), Vector2(160.0f, 0), Tabs::Visual);

		wrapper::reset_height();

		wrapper::checkbox(xorstr_("watermark"), Vector2(320.0f, 0), Tabs::Visual);
...
//		wrapper::checkbox(xorstr_("debug"), Vector2(160.0f, 0), Tabs::Visual, false, true);
		...
		wrapper::combobox(xorstr_("hitbox override"), { xorstr_("none"), xorstr_("body"), xorstr_("head"), xorstr_("random (all)"), xorstr_("random (main)") }, Vector2(140.0f, 0), Tabs::Combat);
		...
		wrapper::checkbox(xorstr_("spider"), Vector2(160.0f, 0), Tabs::Misc);
		wrapper::combobox(xorstr_("crosshair"), { xorstr_("none"), xorstr_("plusminus"), xorstr_("evilcheats"), xorstr_("circle") }, Vector2(160.0f, 0), Tabs::Misc);
		
		wrapper::reset_height();
		
		wrapper::textbox(xorstr_("config name"), Vector2(410.0f, 0), Tabs::Misc, xorstr_("default"));
/*		wrapper::button(xorstr_("Save Config"), [&]() {
		...
		wrapper::label(xorstr_("visible"), Vector2(20, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("visible players"), Vector2(0, 0), Tabs::Colors);
		wrapper::label(xorstr_("invisible"), Vector2(20, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("invisible players"), Vector2(0, 0), Tabs::Colors);
		wrapper::label(xorstr_("visible teammate"), Vector2(20, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("visible teammate"), Vector2(0, 0), Tabs::Colors);
		wrapper::label(xorstr_("invisible teammate"), Vector2(20, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("invisible teammate"), Vector2(0, 0), Tabs::Colors);
		wrapper::label(xorstr_("visible skeleton"), Vector2(20, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("visible skeleton players"), Vector2(0, 0), Tabs::Colors);
		wrapper::label(xorstr_("invisible skeleton"), Vector2(20, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("invisible skeleton players"), Vector2(0, 0), Tabs::Colors);
		wrapper::currentY += 5.0f;

		wrapper::label(xorstr_("sleepers"), Vector2(0, 0), Tabs::Colors);
		wrapper::label(xorstr_("visible"), Vector2(20, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("visible sleepers"), Vector2(0, 0), Tabs::Colors);
		wrapper::label(xorstr_("invisible"), Vector2(20, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("invisible sleepers"), Vector2(0, 0), Tabs::Colors);
		wrapper::label(xorstr_("visible skeleton"), Vector2(20, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("visible skeleton"), Vector2(0, 0), Tabs::Colors);
		wrapper::label(xorstr_("invisible skeleton"), Vector2(20, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("invisible skeleton"), Vector2(0, 0), Tabs::Colors);


		wrapper::reset_height();

		wrapper::label(xorstr_("npcs"), Vector2(130, 0), Tabs::Colors);
		wrapper::label(xorstr_("visible"), Vector2(150, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("visible npcs"), Vector2(130, 0), Tabs::Colors);
		wrapper::label(xorstr_("invisible"), Vector2(150, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("invisible npcs"), Vector2(130, 0), Tabs::Colors);
		wrapper::label(xorstr_("visible skeleton"), Vector2(150, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("visible skeleton npc"), Vector2(130, 0), Tabs::Colors);
		wrapper::label(xorstr_("invisible skeleton"), Vector2(150, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("invisible skeleton npc"), Vector2(130, 0), Tabs::Colors);
		wrapper::currentY += 5.0f;

		wrapper::label(xorstr_("looking direction"), Vector2(150, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("looking direction color"), Vector2(130, 0), Tabs::Colors);
		wrapper::label(xorstr_("targeting fov"), Vector2(150, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("targeting fov color"), Vector2(130, 0), Tabs::Colors);

		wrapper::reset_height();

		wrapper::label(xorstr_("ores"), Vector2(270, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("ores color"), Vector2(250, 0), Tabs::Colors);
		wrapper::label(xorstr_("collectable"), Vector2(270, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("ores collectable"), Vector2(250, 0), Tabs::Colors);
		wrapper::label(xorstr_("stashes"), Vector2(270, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("stashes color"), Vector2(250, 0), Tabs::Colors);
		wrapper::label(xorstr_("corpses"), Vector2(270, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("corpses color"), Vector2(250, 0), Tabs::Colors);
		wrapper::label(xorstr_("traps"), Vector2(270, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("traps color"), Vector2(250, 0), Tabs::Colors);
		wrapper::label(xorstr_("hemp"), Vector2(270, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("hemp color"), Vector2(250, 0), Tabs::Colors);

		wrapper::reset_height();

		wrapper::label(xorstr_("vehicles"), Vector2(370, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("vehicles color"), Vector2(350, 0), Tabs::Colors); // -20 pixels
		wrapper::label(xorstr_("patrol"), Vector2(370, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("helicopter"), Vector2(350, 0), Tabs::Colors);

		wrapper::label(xorstr_("boxes"), Vector2(350, 0), Tabs::Colors);
		wrapper::label(xorstr_("visible"), Vector2(370, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("visible boxes"), Vector2(350, 0), Tabs::Colors);
		wrapper::label(xorstr_("invisible"), Vector2(370, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("invisible boxes"), Vector2(350, 0), Tabs::Colors);
		wrapper::label(xorstr_("targeted"), Vector2(370, 0), Tabs::Colors, false);
		wrapper::color_picker(xorstr_("targeted boxes"), Vector2(350, 0), Tabs::Colors);

		// == Game == \\

		wrapper::reset_height();

		wrapper::keybind(xorstr_("long neck bind"), Vector2(0, 0), Tabs::Game);
		wrapper::checkbox(xorstr_("long neck"), Vector2(0, 0), Tabs::Game);
		wrapper::checkbox(xorstr_("fast loot"), Vector2(0, 0), Tabs::Game);
		wrapper::checkbox(xorstr_("farm assist"), Vector2(0, 0), Tabs::Game);
		wrapper::checkbox(xorstr_("walk on water"), Vector2(0, 0), Tabs::Game);
		
		wrapper::reset_height();

		wrapper::checkbox(xorstr_("bullet tracers"), Vector2(160, 0), Tabs::Game);
		wrapper::checkbox(xorstr_("fake admin"), Vector2(160, 0), Tabs::Game);
		wrapper::checkbox(xorstr_("hitsound"), Vector2(160, 0), Tabs::Game);
		wrapper::checkbox(xorstr_("gravity"), Vector2(160, 0), Tabs::Game);
